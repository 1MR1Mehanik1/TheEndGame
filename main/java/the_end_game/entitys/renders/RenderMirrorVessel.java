...
public class RenderMirrorVessel extends Render<EntityMirrorVessel> {
	private final RenderItem itemRenderer;
	private final Random random = new Random();
	
	public RenderMirrorVessel(RenderManager renderManager, RenderItem itemRendererIn) {
		super(renderManager);
	...
	private int transformModelCount(EntityMirrorVessel itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_) {
	...
	@Override
	public void doRender(EntityMirrorVessel entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityMirrorVessel entity) {
